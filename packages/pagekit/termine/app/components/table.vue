        ...
        <div class="pk-width-content uk-form-stacked">
            ...
            <div class="uk-form-row">
            	...
            	<div class="uk-form-controls uk-form-width-large">
                	<input-image :source.sync="widget.data.meta['og:image']"></input-image>
            	</div>
        </div>
        </div>
...
<script>
	module.exports = {
        ...
        created: function () {
            ...
            if (!this.widget.data.meta) {
                this.$set('widget.data.meta', {'og:title': ''});
            }
        }

    };

    window.Widgets.components['termin-table:content'] = module.exports;
</script>